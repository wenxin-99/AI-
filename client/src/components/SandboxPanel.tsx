 ...
 * 
 * 右栏组件，包含三个 Tab：
 * 1. 浏览器预览 - 显示 Playwright 截图，模拟实时浏览
 * 2. 代码编辑器 - Monaco Editor 显示搜索结果和报告
 * 3. 终端 - 显示 Agent 的执行日志
 */
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-muted/50 border-b">
        ...
        {/* 地址栏 */}
        <div className="flex-1 flex items-center bg-background rounded-md px-3 py-1.5 text-xs border">
          {browser.isLoading && (
      ...
      <div className="flex-1 relative overflow-hidden bg-white dark:bg-zinc-900">
        ...
        {/* 加载遮罩 */}
        {browser.isLoading && browser.screenshot && (
